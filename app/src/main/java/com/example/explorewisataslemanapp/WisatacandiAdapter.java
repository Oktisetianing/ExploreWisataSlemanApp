...
public class WisatacandiAdapter extends RecyclerView.Adapter<WisatacandiAdapter.ViewHolder> {

    WisatacandiModel [] wisatacandilist;

    public WisatacandiAdapter(WisatacandiModel[] wisatacandilist) {

        this.wisatacandilist = wisatacandilist;
    }

    @NonNull
    @Override
    public WisatacandiAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater layoutInflater = LayoutInflater.from(parent.getContext());

        View listwisata = layoutInflater.inflate(R.layout.item_wisata_candi,null);
    ...
    @Override
    public void onBindViewHolder(@NonNull WisatacandiAdapter.ViewHolder holder, int position) {
        WisatacandiModel wisataModel = wisatacandilist[position];
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            maincard = itemView.findViewById(R.id.maincard1);
        }
